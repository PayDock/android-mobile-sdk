...
@Composable
fun OutlineButtonAppearanceStyleEditor(
    currentAppearance: ButtonAppearance.OutlineButtonAppearance,
    onAppearanceChange: (ButtonAppearance.OutlineButtonAppearance) -> Unit
) {
