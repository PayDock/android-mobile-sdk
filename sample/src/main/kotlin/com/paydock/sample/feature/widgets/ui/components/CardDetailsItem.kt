...
fun CardDetailsItem(
    ...
    // `cardDetailsConfig.showSubmitButton` is turned off in the Config screen.
    val cardDetailsWidgetState = rememberCardDetailsWidgetState()
...
//                            }
        ...
        if (!cardDetailsConfig.showSubmitButton) {
            ...
            AppButton(
                ...
                enabled = cardDetailsConfig.activePrimaryButton || cardDetailsWidgetState.isFormValid,
                onClick = { cardDetailsWidgetState.submit() }
            )
        }
    }
}