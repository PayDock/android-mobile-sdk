...
fun HueBar(
    ...
    var selectedHue by remember { mutableFloatStateOf(currentHue) }
    ...
    Canvas(
        ...
        val bitmap = createBitmap(drawScopeSize.width.toInt(), drawScopeSize.height.toInt())
        ...
        val defaultHuePosition = currentHue * huePanel.width() / 360f
        drawCircle(
            Color.White,
