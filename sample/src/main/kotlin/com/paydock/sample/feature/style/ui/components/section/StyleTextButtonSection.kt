...
@Composable
fun TextButtonAppearanceStyleEditor(
    currentAppearance: ButtonAppearance.TextButtonAppearance,
    onAppearanceChange: (ButtonAppearance.TextButtonAppearance) -> Unit
) {
