...
/**
 * This class encapsulates the outcome of an MPGS 3D Secure authentication attempt. It provides details
 ...
 *              status or result of the 3DS authentication. See the `MPGS3dsEventType` enum for possible
 *              event values.
 ...
 */
data class MPGS3dsResult(
    val event: MPGS3dsEventType,
