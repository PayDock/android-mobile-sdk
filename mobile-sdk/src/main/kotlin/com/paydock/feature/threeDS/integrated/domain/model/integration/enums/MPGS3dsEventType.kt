...
/**
 * Enum class representing various event types related to MPGS 3D Secure (3DS) charge processing.
 * This enum includes events that occur in MPGS 3DS authentication flows.
 */
enum class MPGS3dsEventType {
    /**
