...
import com.paydock.feature.src.presentation.utils.MastercardSRCEventSerializer
import kotlinx.serialization.Serializable

/**
 * Represents events related to Mastercard SRC interactions.
 *
 * This sealed class encapsulates various types of events that can occur during Mastercard SRC interactions.
 * Each subclass represents a specific type of event, such as iframe loaded, checkout ready, checkout completed,
 * and checkout error.
 */
@Serializable(with = MastercardSRCEventSerializer::class)
internal sealed class MastercardSRCEvent {
    /**
