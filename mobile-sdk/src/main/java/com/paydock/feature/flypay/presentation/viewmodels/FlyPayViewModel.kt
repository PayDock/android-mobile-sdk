...
internal class FlyPayViewModel(
    ...
    fun createFlyPayUrl(flyPayOrderId: String): String = when (MobileSDK.getInstance().environment) {
        Environment.PRODUCTION -> "https://checkout.cxbflypay.com.au/?orderId=$flyPayOrderId&redirectUrl=$FLY_PAY_REDIRECT_URL"
        else -> "https://checkout.sandbox.cxbflypay.com.au/?orderId=$flyPayOrderId&redirectUrl=$FLY_PAY_REDIRECT_URL" // default to sandbox
    }
}
