...
/**
 * Converts the [ApiErrorResponse] to an [ApiException] with the specified [code].
 *
 ...
 */
internal fun ApiErrorResponse.toApiError(code: Int) = ApiException(code, summary.message)
 ...
 */
internal fun ApiErrorResponse.toApiError() = ApiException(status, summary.message)