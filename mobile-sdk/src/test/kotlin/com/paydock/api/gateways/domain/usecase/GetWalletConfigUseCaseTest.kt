...
internal class GetWalletConfigUseCaseTest : BaseKoinUnitTest() {
    ...
    private lateinit var mockRepository: GatewayRepository
    ...
    fun `test valid gatewayId returns expected paypal clientId result`() = runTest {
        ...
        coEvery {
            mockRepository.getGatewayClientId(
        ...
        // WHEN
        val actualResult =
            getPayPalClientIdUseCase(MobileSDKTestConstants.General.MOCK_ACCESS_TOKEN, MobileSDKTestConstants.General.MOCK_GATEWAY_ID)
        // THEN
